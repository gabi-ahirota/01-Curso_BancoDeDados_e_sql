...
/* WHERE - VAI SER O SEU MELHOR AMIGO NA VIDA PRA VIDA INTEIRA */
...
SELECT COUNT(*) FROM CLIENTE; --CONTAGEM TOTAL
...
INSERT INTO CLIENTE VALUES('CARLA','F','Ç.LOPES@UOL.COM', 46374859, '996749489',
